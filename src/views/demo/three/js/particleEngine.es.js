...
class ParticleEngine {
  ...
  initialize() {
    ...
    for (var i = 0; i < this.particleCount; i++) {
      ...
      // this.particleMaterial.defaultAttributeValues.customVisible.value[i] = this.particleArray[i].alive;
      // this.particleMaterial.defaultAttributeValues.customColor.value[i] = this.particleArray[i].color;
      // this.particleMaterial.defaultAttributeValues.customOpacity.value[i] = this.particleArray[i].opacity;
      // this.particleMaterial.defaultAttributeValues.customSize.value[i] = this.particleArray[i].size;
      // this.particleMaterial.defaultAttributeValues.customAngle.value[i] = this.particleArray[i].angle;
    }

    this.particleMaterial.blending = this.blendStyle;
    if (this.blendStyle != THREE.NormalBlending)
      this.particleMaterial.depthTest = false;
    let system = new THREE.ParticleSystem(this.particleGeometry, this.particleMaterial);
    this.particleMesh = system;
...
var particleFragmentShader = [
  ...
  "vec4 rotatedTexture = texture2D( textureMap,  rotatedUV );",
