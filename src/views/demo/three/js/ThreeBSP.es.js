      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        _results.push(
          (function () {
            ...
            _results1 = [];
            for (
              idx = _j = 2, _ref1 = polyVerts.length; 2 <= _ref1 ? _j < _ref1 : _j > _ref1; idx = 2 <= _ref1 ? ++_j : --_j
            ) {
...
class Vertex extends ThreeBSP {
  construct(x, y, z, normal, uv) {
    this.x = x;
    this.y = y;
    this.z = z;
  ...
  lerp(v, alpha) {
    var _this = this;
    return returning(
      this.lerp.apply(this, arguments),
      function () {
        _this.uv.add(
          v.uv
          .clone()
...
// ThreeBSP.prototype.Vertex = Vertex;
class Polygon extends ThreeBSP {
  construct(vertices, normal, w) {
    ...
    for (i = _i = 0, _len = _ref1.length; _i < _len; i = ++_i) {
      ...
      if ((ti | tj) === SPANNING) {
        t =
          ...
          this.normal.dot(vj.clone().sub(vi));
...
// ThreeBSP.prototype.Polygon = Polygon;
class Node extends ThreeBSP {
  construct(polygons) {
  ...
  clone() {
    ...
    return returning((node = new ThreeBSP.Node()), function () {
      ...
      return (node.back =
        (_ref2 = _this.back) != null ? _ref2.clone() : void 0);
    });
  }
  build(polygons) {
    var _this = this;
  ...
  allPolygons() {
    ...
    return this.polygons
      .slice()
      .concat(
        ((_ref1 = this.front) != null ? _ref1.allPolygons() : void 0) || []
      )
      .concat(
        ((_ref = this.back) != null ? _ref.allPolygons() : void 0) || []
      );
  }
  invert() {
    var _this = this;
