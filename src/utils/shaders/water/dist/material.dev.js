...
exports.waterIMaterial = waterIMaterial;
exports.waterIIMaterial = waterIIMaterial;
exports.waterIIIMaterial = waterIIIMaterial;
...
function waterIMaterial(opts) {
  ...
  var material = new THREE.ShaderMaterial({
    ...
    fragmentShader: require("./frag/waterI.frag")["default"] // blending: THREE.AdditiveBlending,
    // transparent: !0,
    // depthWrite: !1,
    // depthTest: !0,
...
function waterIIMaterial(opts) {
  ...
  var material = new THREE.ShaderMaterial({
    ...
    fragmentShader: require("./frag/water2.frag")["default"] // blending: THREE.AdditiveBlending,
    // transparent: !0,
    // depthWrite: !1,
    // depthTest: !0,
    // side: THREE.DoubleSide,
...
function waterIIIMaterial() {
  var texture = new THREE.TextureLoader().load(require("../texture/CoolWater-iChannel0.jpg"));
